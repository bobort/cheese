...
from accounts.forms import OrderForm, StudentChangeForm
from accounts.models import Order, Student
    ...
    if request.POST:
        ...
        try:
            if token and form.is_valid():
                ...
                return redirect(reverse('accounts:receipt', kwargs={'pk': order.pk}))
...
class ProfileUpdate(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    ...
    success_url = reverse_lazy('public:schedule')
